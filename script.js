...
function ocultar(){
    salidaDeTexto.style.background = "white";
...
function mostrar(){
    salidaDeTexto.style.background = "#FFF no-repeat center url(imagenes/notexto.png)";
